jsPsych.plugins['photo-upload'] = (function(){
  ...
  plugin.trial = function(display_element, trial){
    ...
    display_element.append('<button id="next1" class="button1" style="margin-left: 50%">Submit</button>');
      ...
      $("#next2").click(function() {
        ...
        setTimeout(function(){
          ...
          if (trial.condition == 1) {
              ...
              display_element.append('<div style="text-align: center;">Here is your photo. Please wait while other participants view your photo.&nbsp; &nbsp;</div><div style="text-align: center;"><br><b>Participants currently viewing your photo:&nbsp;</b></div><div style="text-align: center;">&nbsp;</div> <div style="text-align: center;"> <video autoplay="" class="qmedia" height="240" peload="auto" width="360"><source src="https://cdn.rawgit.com/puhseechee/jpsych2/jpsychadd/jspsych-5.0/Alone_30sec.mp4" type="video/mp4"><embed align="middle" autoplay="true" bgcolor="white" class="qmedia" height="240" pluginspage="http://www.apple.com/quicktime/download/" src="https://cdn.rawgit.com/puhseechee/jpsych2/jpsychadd/jspsych-5.0/3user_15sec.mp4" type="video/quicktime" width="360"></video>&nbsp;</div><div style="text-align: center;"><br>The "Next" button will appear in a few moments.&nbsp;</div><div style="text-align: center;">Please click it to continue.</div>');
          } else {
              // same for final condition
              display_element.append('<div style="text-align: center;"><div style="text-align: center;">Here is your photo. Please wait while other participants view your photo.&nbsp; &nbsp;</div><div style="text-align: center;"><br><b>Participants currently viewing your photo:&nbsp;</b></div><div style="text-align: center;">&nbsp;</div><div style="text-align: center;"><video autoplay="" class="qmedia" height="240" peload="auto" width="360"><source src="https://rawgit.com/puhseechee/jpsych2/jpsychadd/jspsych-5.0/Many_30sec.mp4" type="video/mp4"><embed align="middle" autoplay="true" bgcolor="white" class="qmedia" height="240" pluginspage="http://www.apple.com/quicktime/download/" src="https://rawgit.com/puhseechee/jpsych2/jpsychadd/jspsych-5.0/3user_15sec.mp4" type="video/quicktime" width="360"></video>&nbsp;</div><div style="text-align: center;"><br><div style="text-align: center;">The "Next" button will appear in a few moments.&nbsp;</div><div style="text-align: center;">Please click it to continue.</div></div></div>');
          }
